...
func createVotingPoolPkScript(t *testing.T, mgr *waddrmgr.Manager, pool *votingpool.Pool, series uint32, branch votingpool.Branch, index votingpool.Index) []byte {
...
func createSeries(t *testing.T, pool *votingpool.Pool,
...
func createPkScripts(t *testing.T, mgr *waddrmgr.Manager,
	pool *votingpool.Pool, aRange votingpool.AddressRange) [][]byte {
