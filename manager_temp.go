...
func TempManager() *waddrmgr.Manager {
	manager, err := waddrmgr.Create(tempLocation, seed, pubPassphrase, privPassphrase, activeNet.Params)
	if err != nil {
		manager, err = waddrmgr.Open(tempLocation, pubPassphrase, activeNet.Params)
		if err != nil {
